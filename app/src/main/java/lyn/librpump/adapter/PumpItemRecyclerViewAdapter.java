...
import lyn.librpump.fragment.PumpItemFragment.OnListFragmentInteractionListener;
 ...
 */
public class PumpItemRecyclerViewAdapter extends RecyclerView.Adapter<PumpItemRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public PumpItemRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
